  ...
  return (
    <div className="p-6 font-arabic" dir="rtl">
      <Card className="bg-white shadow-sm mb-6">
        <CardHeader>
          <CardTitle className="text-lg font-semibold text-gray-900">بيانات المستخدم</CardTitle>
        </CardHeader>
        <CardContent className="space-y-2">
          ...
          <p><span className="font-medium">تم التحقق من الهاتف:</span> {user.phone_verified_at ? "✅ نعم" : "❌ لا"}</p>
          <p><span className="font-medium">تاريخ الإنشاء:</span> {new Date(user.created_at).toLocaleString()}</p>
        </CardContent>
      </Card>

      <Card className="bg-white shadow-sm">
        <CardHeader>
          <CardTitle className="text-lg font-semibold text-gray-900">الوحدات المرتبطة</CardTitle>
        </CardHeader>
        <CardContent>
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-gray-50 text-sm">
                  <TableHead className="text-right text-gray-700">رقم الوحدة</TableHead>
                  <TableHead className="text-right text-gray-700">الدور</TableHead>
                  <TableHead className="text-right text-gray-700">النوع</TableHead>
                  ...
                  <TableHead className="text-right text-gray-700">متاح؟</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
