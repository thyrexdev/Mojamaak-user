...
/*   { href: "/web-control", label: "التحكم بواجهة الويب", icon: Globe },
 */ 
...
<div className={`h-[73px] flex items-center transition-all duration-300 ${isOpen ? "p-9" : "p-3"}`}>
...
>
  <Icon className={`w-5 h-5 ${isOpen ? "ml-3" : ""} flex-shrink-0`} />
